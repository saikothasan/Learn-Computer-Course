...
public class ShortcutActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.recyclerView = (RecyclerView) findViewById(R.id.shortcut_id);
        getSupportActionBar().setBackgroundDrawable(getDrawable(R.drawable.toolbar_bg));
     
      
        ArrayList arrayList = new ArrayList();
        arrayList.add(new computermodel("Short Cut Terms", R.drawable.btns_13));
        ...
        recyclerView.addOnItemTouchListener(new RecyclerItemClickListener(this, recyclerView, new RecyclerItemClickListener.OnItemClickListener() { 
            ...
            public void onItemClick(View view, final int i) {
                ...
                Intent intent2 = new Intent(ShortcutActivity.this, receiving_activity_shortcut_key.class);
